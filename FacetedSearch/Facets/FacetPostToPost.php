...
class FacetPostToPost extends Facet{
    ...
    {
        parent::__construct($name, $section, $options); // TODO: Change the autogenerated stub
    ...
    {
        $args = wp_parse_args(parent::generateArguments(), $args);
        ...
        if($connectedItems){
            ...
            if(isset($args['post_type']) && is_array($args['post_type'])) {
                ...
                //code to get all post_types and get connection names for each
            }
